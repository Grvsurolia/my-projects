...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]=r"TeamStream2.json"
...
# STREAMING_LIMIT = 24 * 60 * 60 * 1000  # 24 hours
    ...
    for response in responses:
        ...
        if result.is_final:
            ...
            if re.search(r"\b(exit|quit)\b", transcript, re.I):
                ...
                # get_enable_recording_device = os.system(get_enable_command)
                get_enable_command = 'SoundVolumeView.exe /Disable Stereo Mix'
                get_enable_recording_device = os.system(get_enable_command)

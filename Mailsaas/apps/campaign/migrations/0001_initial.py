    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lead_status', models.CharField(blank=True, choices=[('none', 'None'), ('openLead', 'Open Lead'), ('wonLead', 'Won Lead'), ('lostLead', 'Lost Lead'), ('ignoredLead', 'Ignored Lead'), ('forwardedLead', 'Forwarded Lead')], default='none', max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('open_mail_count', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('Campaign_recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='campaign.campaignrecipient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label_name', models.CharField(default='Unlabeled', max_length=500)),
                ('created_date_time', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.AddField(
            model_name='campaign',
            name='label_name',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='campaign.campaignlabel'),
        ),
    ]

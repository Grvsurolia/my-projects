...
from .models import Team, Invitation, TeamData, TeamUser
from .serializers import TeamSerializer, InvitationSerializer, TeamSerializer, CreateTeamSerializer
...
class CreateTeamsView(generics.ListAPIView):
